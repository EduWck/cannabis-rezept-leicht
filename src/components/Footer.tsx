          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <Mail className="text-cannabis-green-500 mr-2 mt-0.5 flex-shrink-0" size={18} />
              ...
              <li className="flex items-start">
                <Phone className="text-cannabis-green-500 mr-2 mt-0.5 flex-shrink-0" size={18} />
                <a href="tel:+4930123456789" className="text-gray-400 hover:text-white transition-colors">+49 (0) 30 123 456 789</a>
              </li>
              <li className="flex items-start">
                <MapPin className="text-cannabis-green-500 mr-2 mt-0.5 flex-shrink-0" size={18} />
