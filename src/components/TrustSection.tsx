    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-dark-gray mb-4">Vertrauen ist unsere Basis</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-gray-50 p-6 rounded-xl">
              ...
              <p className="text-dark-gray mb-4 italic">"{testimonial.quote}"</p>
              <div className="flex justify-between items-center">
                <span className="font-medium text-dark-gray">{testimonial.author}</span>
                <span className="text-dark-gray-light text-sm">{testimonial.date}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gray-50 p-6 rounded-xl flex flex-col items-center text-center">
            <Shield className="text-cannabis-green-500 mb-4" size={32} />
            <h3 className="font-semibold mb-2">DSGVO-konform</h3>
            <p className="text-dark-gray-light text-sm">Alle deine Daten werden verschlüsselt und sicher gespeichert</p>
          </div>
          
          <div className="bg-gray-50 p-6 rounded-xl flex flex-col items-center text-center">
            <div className="mb-4">
              <span className="text-cannabis-green-500 font-bold text-2xl">21+</span>
            </div>
            <h3 className="font-semibold mb-2">Nur für Erwachsene</h3>
            <p className="text-dark-gray-light text-sm">Rezepte nur für Personen über 21 Jahren möglich</p>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-xl flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold mb-2">Geprüfte Ärzte</h3>
            <p className="text-dark-gray-light text-sm">Alle unsere Ärzte sind approbiert und erfahren in Cannabis-Therapie</p>
          </div>
        </div>
      </div>
    </section>
